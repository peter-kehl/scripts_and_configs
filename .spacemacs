...
values."
  ...
  (setq-default
   ...
   dotspacemacs-maximized-at-startup nil ;TODO?; nil
   ...
   ;; (default nil)
   dotspacemacs-smartparens-strict-mode nil ;unneeded?; nil
   ...
   ;; (default nil)
   dotspacemacs-whitespace-cleanup 'changed ;nil
   ))
...
you should place your code here."
  (require 'simpleclip) ;Thanks to https://github.com/rolandwalker/simpleclip#keybindings. In GNOME, change Settings > Devices > Keyboard > "Show the notification list" from Super+V.
  (simpleclip-mode 1)
  )
